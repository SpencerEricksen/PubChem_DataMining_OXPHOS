...
# notes to improve compile bioassay results
etc_linky = [1, 1, 1, 0]
# convert 1/0 to boolean
etc_linky_bool = list(map(bool, etc_linky))
In [4]: etc_linky_bool
Out[4]: [True, True, True, False]

# get pubchem activity outcomes for 4 assays
pc_act = ['active','inactive','active','active']

# perform filter operation on pubchem activity list items 'b' using the boolean list items 'a'
pc_act_relevant = [ b for a, b in zip( etc_linky_bool, pc_act ) if a ]

In [9]: pc_act_relevant
Out[9]: ['active', 'inactive', 'active']

# draw the 6 cpds tested as grid
python ./source/rdkit_draw_6cpds_tested_landscape_v1.6.py ./ML_models/UMAP/diff_map/hitlist_6_cpds_umap_smi.csv
