...
# usage:  python write_cgi_PUG_v1.4.py 
...
# oxphos_merged_aids_records.pkl
aids_data_file = "oxphos_merged_aids_records.pkl"
AID = 'all'
df = pd.read_pickle( aids_data_file )

# get unique list of all CIDs in merged data set
cids = df['PUBCHEM_CID'].unique().tolist()
...
for cid in cids:
    ...
    if count < 249999:
        ...
        out_xml_file = open('./fetch_CGIs_bulk/pc_fetch_'+AID+'_'+str(chunk)+'.cgi', 'w')
