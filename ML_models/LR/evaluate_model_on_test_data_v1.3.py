...
import pandas as pd
import numpy as np
from sklearn.metrics import f1_score, matthews_corrcoef, average_precision_score, roc_auc_score, balanced_accuracy_score
import sys
...
try:
    ...
    test_data = sys.argv[3]  # "../data/old_85_15_split/test_data.pkl"
except:
    print('provide feat_type (desc, fps, both), model_file (pkl), and test_data (pkl) as arguments')
    sys.exit(1)
...
print('model,balanced_acc,avg_prec,roc_auc,F1,MCC,EF1,NEF1')
print(model_name, bac, avgprec, rocauc, f1, mcc, ef1, nef1)
