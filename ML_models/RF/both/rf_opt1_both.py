    ...
    for i in [ 600 ]: 
        ...
        for j in [ 0.05, 0.25, 0.50, None]:
            ...
            for d in [ 4, 6, 8, 16, 32, None ]:
                ...
                for k in [ 0.005, 0.02, 0.05, 0.10, 0.15, 0.25, 0.5 ]:
                    key_k = '%.2f' % k
...
models = get_models()
print('ntrees_nsamples_ndepth_nfeats, bal_acc, (bal_acc), avg_prec, (avg_prec), roc_auc, (roc_auc), f1, (f1)')

f = open('rf_opt1_both_loggers.txt','w')
