...
def evaluate_model(model, X, y):
    ...
    scores = cross_val_score(model, X, y, scoring='average_precision', cv=cv, n_jobs=-1, error_score='raise')
    return scores
...
print('>ntrees_nsamples_ndepth_nfeats,avg_prec_mean,avg_prec_std')
