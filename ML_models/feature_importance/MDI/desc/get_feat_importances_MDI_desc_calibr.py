...
model_name = "../../../RF/model_RF_desc_8000_1.0_none_0.050_3way.pkl"
...
df4.to_csv('RF_calibr_desc_MDI.csv', index=False )
...
fig.tight_layout()
plt.savefig('RFC_calibr_desc_feat_MDI_top20.png', dpi=1600 )
plt.close()
...
fig.tight_layout()
plt.savefig('RFC_calibr_desc_feat_MDI_frags.png', dpi=1600 )
plt.close()
...
fig.tight_layout()
plt.savefig('RFC_calibr_desc_feat_MDI_props.png', dpi=1600 )
plt.close()
