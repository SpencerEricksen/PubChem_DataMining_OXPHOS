...
result = permutation_importance( mymodel, X, y, n_repeats=10, random_state=42, scoring='roc_auc' )
...
df4.to_csv('RF_nocalibr_desc_perm_feat_importances_test_rocauc.csv', index=False )
