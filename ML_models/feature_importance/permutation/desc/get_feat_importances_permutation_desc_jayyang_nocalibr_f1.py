...
result = permutation_importance( mymodel, X, y, n_repeats=10, random_state=42, scoring='f1' )
...
df4.to_csv('RF_nocalibr_desc_perm_feat_importances_test_f1.csv', index=False )
