...
fig.tight_layout()
plt.savefig('RFC_desc_feat_importances_impurity_top20.png', dpi=1600 )
plt.close()
...
fig.tight_layout()
plt.savefig('RFC_desc_feat_importances_impurity_frags.png', dpi=1600 )
plt.close()
...
fig.tight_layout()
plt.savefig('RFC_desc_feat_importances_impurity_props.png', dpi=1600 )
plt.close()
